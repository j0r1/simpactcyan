...
void EventSyphilisProgression::fire(Algorithm *pAlgorithm, State *pState, double t)
{
  ...
  pPerson->syphilis().progress(t, false);
  ...
  if(pPerson->syphilis().isInfectious()){
...
JSONConfig syphilisProgressionJSONConfig(R"JSON(
  ...
  "depends": null,
  "params": [
  [ "syphilisprogression.primarystageduration.dist", "distTypes", [ "fixed", [ [ "value", 0.15 ] ] ] ],
  [ "syphilisprogression.secondarystageduration.dist", "distTypes", [ "fixed", [ [ "value", 0.3 ] ] ] ],
  [ "syphilisprogression.latentstageduration.dist", "distTypes", [ "fixed", [ [ "value", 1 ] ] ] ]
  ],
            "info": [
  "TODO"
            ]
